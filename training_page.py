...
def training():
    ...
    use_grid_cv = st.checkbox('Use Grid Search CV', False)
    ...
    if not use_grid_cv:
        ...
        params_df = pd.DataFrame.from_dict(filtered_params)
        edited_param_df = st.experimental_data_editor(params_df, width=1440, key='grid_cv_params', num_rows='dynamic')
